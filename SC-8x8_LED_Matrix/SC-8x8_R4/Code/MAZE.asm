...
MAZKEY  .DB    05
	.DB    02H,0AH,05H,07H
	.DB    10H
	.DW    UPKEY,DWNKEY,LFTKEY,RHTKEY
	.DW    ENDKEY
;
; EXIT DISPLAY PATTERNS
;
EXIT1   .DB    0FFH,081H,0BDH,0A5H,0A5H,0BDH,081H,0FFH
EXIT2   .DB    000H,07EH,042H,05AH,05AH,042H,07EH,000H
;----------
; QUIT MAZE
;----------
ENDKEY  LD      C,KEYREL
...
; FIRST ROW
;
	.DB    0FFH,088H,0A2H,0BEH,0A2H,0AAH,08AH,0BAH  ;1ST COLUMN
	.DB    0FFH,011H,0D5H,094H,0B7H,084H,0D1H,01DH  ;2
	.DB    0FFH,001H,05DH,051H,0D4H,055H,055H,055H  ;3
	.DB    0FFH,010H,055H,055H,045H,0DDH,011H,055H  ;4
	.DB    0FFH,008H,0EBH,00AH,07BH,040H,05FH,051H  ;5
	.DB    0FFH,011H,0D5H,005H,0FDH,005H,0F5H,015H  ;6
;
; SECOND ROW
;
	.DB    088H,0EBH,088H,0BFH,082H,0BAH,0A2H,0AFH
	.DB    050H,0D7H,042H,07AH,042H,0DEH,010H,0D7H
	.DB    055H,0D5H,004H,0BFH,0A2H,0AAH,088H,0FEH
	.DB    055H,054H,057H,0D1H,004H,0BFH,0A0H,0AFH
	.DB    055H,055H,055H,054H,057H,0C4H,01DH,0C4H
	.DB    055H,045H,07DH,001H,0FFH,001H,0F7H,015H
;
; THIRD ROW
;
	.DB    0A2H,0BAH,0A0H,0AEH,082H,0FBH,080H,0BEH
	.DB    014H,0F5H,080H,0BEH,010H,0D5H,015H,0D4H
	.DB    002H,0FAH,000H,0BFH,0A0H,0AFH,0A0H,02FH
	.DB    0A8H,0ABH,02AH,0EAH,000H,0EFH,028H,0AAH
	.DB    07FH,000H,0FFH,020H,03FH,0A2H,0AAH,0AAH
EXIT    .DB    0D5H,015H,0F5H,005H,0DDH,051H,015H,0F5H
;
; FOURTH ROW
;
	.DB    082H,0FBH,081H,0BFH,081H,0BDH,084H,0B7H
	.DB    055H,054H,055H,054H,011H,057H,054H,0D5H
	.DB    0E8H,00AH,0FAH,012H,0D7H,040H,05FH,040H
	.DB    0AAH,0AAH,0A2H,03FH,0A0H,02FH,0E8H,00AH
	.DB    08AH,0FAH,00AH,0EAH,02AH,0AAH,0AAH,0AAH
	.DB    085H,03DH,085H,0F1H,09FH,0B1H,095H,0D5H
;
; FIFTH ROW
;
	.DB    0A0H,0AFH,081H,0ADH,0A8H,0ABH,0A0H,0AFH
	.DB    055H,055H,015H,0F5H,004H,0DDH,011H,0F7H
	.DB    07FH,044H,055H,055H,011H,0FFH,000H,05FH
	.DB    0FAH,042H,05AH,05AH,002H,0EFH,020H,0BEH
	.DB    0A2H,0BFH,080H,0FFH,000H,0FFH,080H,0BFH
	.DB    015H,0F5H,005H,0FDH,005H,0F5H,015H,055H
;
; SIXTH ROW
;
	.DB    0A8H,0AAH,0AAH,0ABH,0A0H,0BFH,080H,0FFH
	.DB    004H,0F5H,011H,0D5H,014H,0D7H,010H,0FFH
	.DB    042H,0FAH,002H,05EH,040H,0FFH,000H,0FFH
ENTRY   .DB    020H,0AFH,0A0H,0BFH,080H,0FFH,000H,0FFH
	.DB    081H,0BDH,020H,0EDH,005H,0F5H,004H,0FFH
	.DB    055H,055H,045H,0F5H,015H,055H,041H,0FFH
	.END
