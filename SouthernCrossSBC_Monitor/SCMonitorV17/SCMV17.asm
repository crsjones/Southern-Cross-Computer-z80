...
#DEFINE TEC-1F
; USE 74C923 KEYBOARD ENCODER ELSE USE SOFTWARE SCANNING
;#DEFINE 74C923
;
; I/O PORT ADDRESSES
;
...
#IFDEF TEC-1F
	...
	AND	5FH	;STRIP UNUSED BITS
	BIT	6,A	;DA LOW?
	JR	Z,SCANKY1
	LD	A,00H
	JR	SCANKY2
SCANKY1	SET	5,A	;SET DATA AVAILABLE FLAG 
SCANKY2	POP	HL
	POP	DE
	POP	BC
	RET
...
;
CRLF	.DB	CR,LF,0
SIGNON	.DB	" Southern Cross Serial Monitor ",0
CMDLST	.DB	CR,LF,"H for command list",CR,LF,0
REGS 	.DB	CR,LF,"PC   AF   BC   DE   HL   IX   IY   SP   SZ-H-VNC",CR,LF,0
TOGGLE	.DB	CR,LF,"Single Step Toggle",CR,LF,0
TXFILE	.DB	CR,LF,"Send INTEL Hex File...",0
FILEOK	.DB	CR,LF,"File Received OK",CR,LF,0
CSUMERR	.DB	CR,LF,"Checksum Error",CR,LF,0
BYE	.DB	CR,LF,"Bye...",CR,LF,0
;
;VT100 TERMINAL COMMANDS FOR CLEAR SCREEN,CURSOR HOME
;
INITSZ	.DB	27,"[H",27,"[2J",0
	.END
