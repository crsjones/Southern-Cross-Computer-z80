...
TMPPC:	.EQU	3FE0H	;PROGRAM COUNTER
TMPAF:	.EQU	3FE2H	;ACCUMULATOR,FLAG
TMPBC:	.EQU	3FE4H	;BC REGISTER PAIR
TMPDE:	.EQU	3FE6H	;DE REGISTER PAIR
TMPHL:	.EQU	3FE8H	;HL REGISTER PAIR
TMPIX:	.EQU	3FEAH	;INDEX REGISTER X
TMPIY:	.EQU	3FECH	;INDEX REGISTER Y
TMPSP:	.EQU	3FEEH	;STACK POINTER
;
...
;
CRLF:        .DB     CR,LF,00H
SIGNON:      .DB     "SCM 1.5 SERIAL MONITOR",CR,LF,"ACCEPTS ONLY UPPER CASE - H FOR COMMAND LIST",CR,LF,00H
REGS:        .DB     CR,LF,"PC   AF   BC   DE   HL   IX   IY   SP   SZ-H-VNC",CR,LF,00H
...
COMANDS:     .DB     CR,LF,"D AAAA    DISPLAY DATA AT ADDRESS AAAA"
            ...
            .DB     CR,LF,"M AAAA    MODIFY ADDRESS AAAA",00H
            
COMANDS1:    .DB     CR,LF,"G AAAA    GO FROM AAAA"     
            .DB     CR,LF,"I         DOWNLOAD INTEL HEX"
            .DB     CR,LF,"X         EXIT"
            .DB     CR,LF,"H         THIS HELP MESSAGE",CR,LF,00H
;
