...
; VERSION 1.81 03/2023  ZERO TERMINATE THE ASCII CONVERSION STRINGS
...
SYSJMP	.DW	MAIN,VERS,DISADD,DISBYT,CLRBUF,SCAND,CONBYT,CONVHI
	...
	.DW RAND,INDEXB,INDEXW,MUSIC,TONE,BEEP,SKATE,TXDATA
	.DW RXDATA,ASCHEX,WWATCH,RWATCH,ONESEC,RLSTEP,DELONE,SCANKEY
	
	.DW INTELH,SPLIT,SNDMSG,BITASC,WRDASC,BYTASC,NYBASC,PCBTYP
	.DW PRNTSZ,KBDTYP,UPDATE,VARRAM,SERINI,SCBUG,TRAP,TRAP
