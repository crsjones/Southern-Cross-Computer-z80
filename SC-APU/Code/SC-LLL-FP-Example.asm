...
; SC-APU.asm
; Example code for -
; Lawrence Livermore Laboratory Floating Point Package
;
; Craig Jones  March 2022
; see the library header below my example code for acknowledgements
;
; this file assembles with TASM for either the TEC-1F or the SC
;
; define board  
;#def  TEC-1F
...
main:   call   InitialiseSerial     ;initialise the bitbang serial 
        call  printsz
